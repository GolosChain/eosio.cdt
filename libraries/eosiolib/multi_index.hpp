...
template<table_name_t TableName> struct lower_bound<TableName, "primary"_n> final {
...
template<table_name_t TableName> struct upper_bound<TableName, "primary"_n> final {
    cursor_t operator()(account_name_t code, scope_t scope, const primary_key_t pk) const {
