...
class [[eosio::contract]] second_fail_provider : public eosio::contract {
public:
  second_fail_provider( eosio::name receiver, eosio::name code, eosio::datastream<const char*> ds) : eosio::contract(receiver, code, ds) {}
...
EOSIO_DISPATCH( second_fail_provider, (approvebw))
