...
class [[eosio::contract]] second_verifing_provider : public eosio::contract {
public:
  second_verifing_provider( eosio::name receiver, eosio::name code, eosio::datastream<const char*> ds) : eosio::contract(receiver, code, ds) {}
...
EOSIO_DISPATCH( second_verifing_provider, (approvebw)(verify))
